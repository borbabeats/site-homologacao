...
function Metrology({ id }) {
    const isDesktop = useMediaQuery({ minWidth: 992 });
    const { t } = useTranslation()

    console.log(t('tecnologia.metrologia.texto', { returnObjects: true }));
        ...
        <Container>
            <Row className='mt-3'>
                <Col className="ml-auto mr-auto" md="12" lg="15" sm="12">
                    {t('tecnologia.metrologia.texto', { returnObjects: true }).map(({ titulo, subtitulo, texto, itens }, index) => <div key={index}>
