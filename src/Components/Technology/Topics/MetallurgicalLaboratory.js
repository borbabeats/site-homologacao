...
function MetallurgicalLaboratory({ id }) {
        ...
        <Container>
            <Row className='mt-3'>
                <Col className="ml-auto mr-auto" md="12" lg="15" sm="12">
                    {t('tecnologia.laboratorio-metalurgico.texto', { returnObjects: true }).map(({ titulo, subtitulo, texto, itens }, index) => <div key={index}>
...
export default MetallurgicalLaboratory;