        ...
        <Container>
            <Row className='mt-3'>
                <Col className="ml-auto mr-auto" md="12" lg="15" sm="12">
                    {t('tecnologia.usinagem-2.texto', { returnObjects: true }).map(({ titulo, subtitulo, texto, itens }, index) => <div key={index}>
